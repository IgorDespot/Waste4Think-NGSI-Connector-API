...
const header = require('./headerCheck');
...
function listEntitiesPromise(service, service_path) {
    return new Promise(function (resolve, reject) {
        request({
            method: 'GET',
            url: orionPath,
            headers: header(service, service_path)
...
function entityCreatePromise(service, service_path, entity) {
    return new Promise(function (resolve, reject) {
        request({
            method: 'POST',
            url: orionPath + '?options=keyValues',
            headers: {
...
function entityUpdatePromise(service, service_path, entity) {
    return new Promise((resolve, reject) => {
        request({
            method: 'PATCH',
            url: orionPath + '/' + entity.id + '/attrs?options=keyValues',
            headers: {
                "Content-Type": 'application/json',
                "Fiware-Service": service,
                "Fiware-ServicePath": service_path
